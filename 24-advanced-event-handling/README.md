...
4. Use the `dataset` attribute to store data on specific DOM elements

## Deliverables
- [ ] User should be able to delete a meme post when they click on the delete button
- [ ] User should be able to upvote a meme post when they click on the like button and the likes count should increase
